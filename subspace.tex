...
\{\x_1, \x_2, \dots, \x_n\} \subset \R^d$ and a positive integer $k$. The goal
is to find centers $\c_1, \c_2, \dots, \c_k \in \R^d$ that minimize
$$
...
w_n)\} \subset \R^d \times \R_+$ and a positive integer $k$. The goal is to find
centers $\c_1, \c_2, \dots, \c_k \in \R^d$ that minimize
$$
